...
import { GraduationCap, Mail, Lock, User, ArrowLeft, Eye, EyeOff, Github, LogIn } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if(isLogin){
        ...
        const response = await fetch("http://localhost:5000/api/studentSignup/sign",{
          method:'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-12  ">
        <div className="mx-auto w-full max-w-md">
          ...
          <Link to="http://localhost:5000/auth/google"> <Button variant="outline" className="h-12 hover:bg-black hover:text-white cursor-pointer" >
              Google
            </Button>
            </Link>
      ...
      <div className="hidden lg:flex flex-1 bg-red-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-md mb-8">
            Connect with expert teachers, book personalized sessions, and achieve your academic goals with EduConnect.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-primary-foreground/90">Access 1000+ verified teachers</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-primary-foreground/90">Book sessions at your convenience</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-primary-foreground/90">Learn from anywhere, anytime</span>
            </div>
          </div>
        </div>
